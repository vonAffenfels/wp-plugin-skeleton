...
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\AddBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\AndBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\BitwiseAndBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\BitwiseOrBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\BitwiseXorBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\ConcatBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\DivBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\EndsWithBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\EqualBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\FloorDivBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\GreaterBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\GreaterEqualBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\HasEveryBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\HasSomeBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\InBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\LessBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\LessEqualBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\MatchesBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\ModBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\MulBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\NotEqualBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\NotInBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\OrBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\PowerBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\RangeBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\SpaceshipBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\StartsWithBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Binary\SubBinary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Filter\DefaultFilter;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\NullCoalesceExpression;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Test\ConstantTest;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Test\DefinedTest;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Test\DivisiblebyTest;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Test\EvenTest;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Test\NullTest;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Test\OddTest;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Test\SameasTest;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Unary\NegUnary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Unary\NotUnary;
use WPPluginSkeleton_Vendor\Twig\Node\Expression\Unary\PosUnary;
use WPPluginSkeleton_Vendor\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use WPPluginSkeleton_Vendor\Twig\TokenParser\ApplyTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\BlockTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\DeprecatedTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\DoTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\EmbedTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\ExtendsTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\FlushTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\ForTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\FromTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\IfTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\ImportTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\IncludeTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\MacroTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\SetTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\UseTokenParser;
use WPPluginSkeleton_Vendor\Twig\TokenParser\WithTokenParser;
...
use WPPluginSkeleton_Vendor\Twig\Extension\CoreExtension;
use WPPluginSkeleton_Vendor\Twig\Extension\SandboxExtension;
use WPPluginSkeleton_Vendor\Twig\Markup;
use WPPluginSkeleton_Vendor\Twig\Source;
use WPPluginSkeleton_Vendor\Twig\Template;
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('WPPluginSkeleton_Vendor\\Twig\\Extension\\SandboxExtension') && $env->getExtension('WPPluginSkeleton_Vendor\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
