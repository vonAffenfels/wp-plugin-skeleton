 ...
 */
use WPPluginSkeleton_Vendor\Symfony\Polyfill\Mbstring as p;
...
if (!\function_exists('WPPluginSkeleton_Vendor\\mb_str_pad')) {
    /** @internal */
...
if (!\function_exists('WPPluginSkeleton_Vendor\\mb_ucfirst')) {
    /** @internal */
...
if (!\function_exists('WPPluginSkeleton_Vendor\\mb_lcfirst')) {
    /** @internal */
...
if (!\function_exists('WPPluginSkeleton_Vendor\\mb_trim')) {
    /** @internal */
...
if (!\function_exists('WPPluginSkeleton_Vendor\\mb_ltrim')) {
    /** @internal */
...
if (!\function_exists('WPPluginSkeleton_Vendor\\mb_rtrim')) {
    /** @internal */
