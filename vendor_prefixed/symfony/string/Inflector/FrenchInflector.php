 ...
 */
namespace WPPluginSkeleton_Vendor\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'WPPluginSkeleton_Vendor\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'WPPluginSkeleton_Vendor\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'WPPluginSkeleton_Vendor\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'WPPluginSkeleton_Vendor\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'WPPluginSkeleton_Vendor\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'WPPluginSkeleton_Vendor\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
